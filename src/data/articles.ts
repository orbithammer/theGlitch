export const articlesData = [
    ...
    },
    {
        ...
        subhead: `Company pivots to new model where you drive yourself but still pay them`,
        tags: [`Uber`],
        author: `Et Al`,
        ...
        articleBody: [
            ...
            `"We asked ourselves, 'How can we make Uber even more efficient?'" said Chad Moneybags, Uber's Chief Disruption Officer. "The answer was staring us right in the face: let the passengers do all the work!"`,
            ...
            `"It's like having a backseat driver, but in app form," explained Moneybags, beaming with pride. "And the best part? You get to pay for it!"
           ...
           ` "We're really excited about the self-rating system," gushed Tiffany Techspeak, Uber's Head of Unnecessary Features. "Users can give themselves one to five stars based on how much they enjoyed driving themselves around. It's a game-changer in the field of self-affirmation technology."`,
            `When asked about the potential impact on Uber's existing driver network, company spokesperson Ivy League-Dropout waved off concerns. "Our drivers are our family," she said, while simultaneously sending a company-wide email about upcoming 'family downsizing initiatives.' "We're simply expanding our definition of 'driver' to include 'people who drive themselves and pay us for no reason.'"`,
            `The new service has already garnered rave reviews from beta testers. "It's amazing," enthused early adopter Tim Gullible. "Yesterday, I drove myself to work, paid Uber $15, and then rated myself 5 stars. I've never felt so empowered!"`,
            `Critics have pointed out that the new service is essentially just driving your own car while burning money, but Uber remains undeterred. "That's the kind of narrow-minded thinking that would have prevented the invention of pet rocks or bottled air," retorted Moneybags. "We're not just selling a service here; we're selling an experience. An experience of driving yourself and pretending you're using Uber."`,
